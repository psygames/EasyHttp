...
namespace EasyUtils
{
    public static class MuEncode
    {
        ...
        static readonly string[] hanzi =
        {
            ...
            ,"段","便","俩","顺","修","保","促","侮","俭","俗","俘","信","皇","泉","鬼","侵","追","俊","盾","待","律","很","须","叙"
            ...
            ,"姆","虱","绅","驹","绊","绎","契","贰","玷","玲","珊","拭","拷","拱","挟","垢","垛","拯","荆","茸","茬","荚","茵","茴"
            ...
            ,"逊","陨","姚","娜","蚤","骇","耙","秦","匿","埂","捂","捍","袁","捌","挫","挚","捣","捅","埃","耿","聂","荸","莽","莱"
            ...
            ,"掖","掷","掸","掺","勘","聊","娶","菱","菲","萎","菩","萤","萧","萨","菇","彬","梗","梧","梭","曹","酝","酗","厢","硅"
            ,"硕","奢","盔","匾","颅","彪","眶","晤","曼","晦","冕","啡","畦","趾","啃","蛆","蚯","蛉","蛀","唬","啰","唾","啤","啥","啸"
            ,"崎","逻","崔","崩","婴","赊","铐","铛","铝","铡","铣","铭","矫","秸","秽","笙","笤","偎","傀","躯","兜","衅","徘","舶"
