...
namespace EasyHttp
{
    public class Http
    {
        public static Task<string> GetText(string url, string proxy = null)
        {
            return InnerHttp.GetText(url, proxy);
        }

        public static Task<byte[]> GetBytes(string url, string proxy = null)
        {
            return InnerHttp.GetBytes(url, proxy);
        }

        public static Task<bool> Download(string url, string path, IProgress<long[]> progress = null, string proxy = null)
        {
